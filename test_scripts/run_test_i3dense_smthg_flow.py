...
arguments = [
    ...
    test_folder, '--use_flow', '--flow_type', 'tvl1', '--network', network,
    '--gpu_parallel', '--gpu_nb', '1', '--save_predictions', '--threads', '8',
    '--checkpoint_path',
    'checkpoints/' + train_folder + '/' + network + '_adapt_epoch_60.pth',
