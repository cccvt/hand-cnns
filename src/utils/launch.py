...
def get_smthg_test(network, modality, dataset, experience, split, epoch):
    test_folder = os.path.join('test', network, modality, dataset, experience, 'epoch_{}'.format(epoch), split)
    return test_folder
...
def get_smthg_paths(network, modality, dataset, experience, split, epoch):
    ...
    test_folder = get_smthg_test(network, modality, dataset, experience, split, epoch)
